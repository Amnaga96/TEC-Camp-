...
Route::get('/questions/{qid}/show', 'QuestionController@show')->middleware('auth');
 ...
 Route::get('create-article', 'ArticleController@create')->middleware('auth');;//create a new article
 Route::post('create-article', 'ArticleController@store')->middleware('auth');; //store a new article
 Route::get('article/{a_id}', 'ArticleController@show')->name('show')->middleware('auth');; //show an article
 Route::get('article/edit/{a_id}', 'ArticleController@edit')->middleware('auth'); //to edit an article
 Route::patch('article/{a_id}', 'ArticleController@update')->middleware('auth'); 
 Route::get('article/{a_id}', 'ArticleController@destroy')->middleware('auth'); //to delete an article
