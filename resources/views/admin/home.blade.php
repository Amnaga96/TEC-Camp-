    ...
    <div class="text-center shadow-lg p-2 mb-5 mb-5 bd-with  bg-white rounded mx-auto d-block bg-img">
        <div class="row justify-content-center">
            <div class="col-md-8 text-info mt-3 mb-3 mr-2 pt-5 bg-img">
                <div class="card brod text-center shadow-lg p-5 mb-2 bd-with  bg-white rounded mx-auto d-block text-center">
                    <div class="card-header shadow-lg bd-with  bg-white rounded mx-auto d-block">Mangment</div>
                    <div class="card-body">
                    @if (session('status'))
